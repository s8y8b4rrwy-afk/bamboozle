...
const HomeSelector = ({ onSelect }: { onSelect: (v: 'HOST' | 'PLAYER' | 'TEST') => void }) => (
  <div className="h-full w-full bg-gradient-to-br from-indigo-900 via-purple-900 to-black text-white flex flex-col items-center justify-center p-4 relative overflow-y-auto">
    ...
    <div className="relative z-10 w-full max-w-6xl flex flex-col items-center py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 w-full max-w-sm md:max-w-none">
        <button
        ...
        >
          ...
          <p className="text-xs md:text-sm font-bold opacity-60 uppercase tracking-widest">Big Screen / TV</p>
        </button>
