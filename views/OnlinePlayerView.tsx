...
import { RevealSequence, LeaderboardSequence, CategoryRoulette, PointsPopup, EmotePopupLayer, CountUp } from './HostView';
              ...
              {me && (
                  <div className="mt-8 z-20 w-full max-w-md space-y-4">
                      <button 
                           ...
                           className={`w-full py-4 rounded-xl font-black text-xl shadow-lg uppercase transition-all transform active:scale-95 ${
                               me?.isReady 
  ...
  if (state.phase === GamePhase.REVEAL) {
      return (
          <div className="h-full w-full bg-gray-900 relative overflow-hidden">
               <EmotePopupLayer emotes={state.emotes} />
               <RevealSequence state={state} actions={actions} setGalleryOverrides={() => {}} />
               <EmoteGrid />
          </div>
      );
  }
      ...
      return (
          <div className="h-full w-full bg-gray-900 relative overflow-hidden flex flex-col">
               ...
               <div className="flex-1 relative z-10 mt-8">
                   <LeaderboardSequence state={state} actions={actions} onHome={() => {}} />
               </div>
